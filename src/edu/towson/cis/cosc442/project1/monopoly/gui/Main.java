...
public class Main {
	...
	/**
	 * Prompts the user via the given window to input the number of players until a valid number is entered, sets the number in GameMaster, and returns it.
	 * @param window the MainWindow used as the parent component for dialog boxes
	 * @return the valid number of players input by the user
	 */
	...
	/**
	 * Initializes the game by optionally setting test mode and game board from args, creates the main window, prompts for player names, sets up and starts the game.
	 * @param args command-line arguments specifying test mode and optional game board class name
	 */
